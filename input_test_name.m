function name = input_test_name(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as column vectors.
%   NAME = IMPORTFILE(FILENAME) Reads data from text file FILENAME for the
%   default selection.
%
%   NAME = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   name = importfile('test_out.txt',1, 180406);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2015/04/03 15:38:15
